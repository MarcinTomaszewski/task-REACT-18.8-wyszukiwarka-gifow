App = React.createClass({
    ...
    getGif: function (searchingText, callback) {  // 1.Na wejście metody getGif przyjmujemy dwa parametry: wpisywany tekst (searchingText) i funkcję, która ma się wykonać po pobraniu gifa (callback).
        var GIPHY_PUB_KEY = 'usNlFAwDWB1MTebWB8EiPxDbfmdL6FgI';
    ...
    render: function () {
        ...
        //  dodanie styli za pomocą stworzonego obiektu i umieszczeniu go w dowolnym elemencie we właściwościach style.
        var styles = {
            margin: '0 auto',
            textAlign: 'center',
            width: '90%'
